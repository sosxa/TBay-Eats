...
const CategorySelector: React.FC<CategorySelectorProps> = ({
  ...
  useEffect(() => {
    ...
    setSelectedCategoryState(capitalizedCategory);
  ...
  const updateUrlParams = (newCategory: string | undefined, newListingType?: 'combos' | 'products') => {
  ...
  const handleListingTypeChange = (type: 'combos' | 'products') => {
