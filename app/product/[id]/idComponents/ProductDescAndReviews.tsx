...
import submitProductReview from './submitProductReview';
...
const ProductDescAndReviews: React.FC<DescReviewsProps> = ({ description, reviews, reviewAmount, productEmail, productName }) => {
    ...
    try {
        // Ensure reviews is an array and slice it safely
        reviewsToDisplay = Array.isArray(reviews) ? reviews.slice(0, visibleReviewsCount) : [];
    } catch (error) {
        console.error('Error slicing reviews:', error);
        reviewsToDisplay = [];
    }
                        ...
                        {showReviewForm && (
                            <form onSubmit={handleSubmit} className="mb-4">
                                ...
                                <button
                                    ...
                                    onClick={() => submitProductReview(reviewTitle, reviewMessage, rating, productEmail, productName)}
                                >
                                    Submit Review
                                </button>
                            </form>
